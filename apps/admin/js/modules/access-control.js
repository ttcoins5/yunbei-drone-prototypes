...
DroneAdmin.registerModule({
  ...
  docs: {
    "admin-users": {
      ...
      fields: [["姓名","后台用户真实姓名"],["账号","后台登录账号"],["登录账号","后台登录账号，编辑弹窗字段名"],["手机号","用于联系和二次验证"],["角色","决定该用户可见页面"],["状态","启用或停用；停用后真实系统应禁止登录"],["最近登录","最近一次登录后台的时间"],["操作","编辑用户资料、切换视角或查看该角色可见菜单"]]
    },
    "roles": {
      ...
      fields: [["角色名称","后台角色展示名称"],["角色说明","说明该角色职责范围，编辑时使用多行文本"],["页面权限","该角色登录后可见的后台页面集合"],["状态","系统内置或可编辑；系统内置角色不可删除"],["操作","编辑该角色的页面权限或删除自定义角色"]]
    }
  },
  pages: {
