...
DroneAdmin.registerModule({
  ...
  "tasks": {
    ...
    "fields": [
      ...
      [
        "状态",
        "征集状态。征集中表示飞手端可继续报名；已关闭表示不再接收新意愿，但不代表任务完成或取消"
      ],
      [
        "意愿人数",
        "已表达参与意向的飞手数量"
      ...
      [
        "指派状态",
        "后台派单进度。待指派表示尚未选定飞手；已指派 N 人表示已生成指派结果；已完成表示所有已指派飞手完成服务"
      ],
      [
        "操作",
        "查看详情、查看意愿并指派、重新指派或关闭征集；飞手全部完成后指派状态显示已完成"
      ]
    ]
  },
  "task-detail": {
    ...
    "fields": [
      ...
      [
        "飞手分配",
        "后台可从意愿飞手中指派或重新指派，飞手不能自主接单"
      ],
      [
        "区域",
        "飞手服务区域，用于后台指派时判断是否匹配任务地点"
      ],
      [
        "设备",
        "飞手可用设备或机型，用于判断是否满足任务要求"
      ]
    ]
  }
},
