DroneAdmin.data.requirementTemplates = [
  {
    id: "tpl-inspection",
    name: "巡检服务模板",
    serviceType: "无人机巡检服务",
...
function getRequirementTemplate(templateId) {
  return DroneAdmin.data.requirementTemplates.find(item => item.id === templateId) || DroneAdmin.data.requirementTemplates[2];
}

function cloneRequirementTemplate(templateId) {
