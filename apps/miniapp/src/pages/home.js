import { categories, homepageNavItems, products } from "../data/catalog.js?v=miniapp-live-20260624-task-detail-clean-1";
import { caseStudies } from "../data/caseStudies.js?v=miniapp-live-20260624-task-detail-clean-1";
